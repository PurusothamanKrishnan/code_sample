...
set OPENCV_PATH=%PROJ_PATH%tools\
...
if exist "%OPENCV_PATH%" (
	...
	if "%ARCH%"=="64" (
		set OPENCV_LIB_PATH=%OPENCV_PATH%\opencv\lib
		set OPENCV_BIN_PATH=%OPENCV_PATH%\opencv\bin
		set OPENCV_STATICLIB_PATH=%OPENCV_PATH%\opencv\lib
	) ELSE (
		set OPENCV_LIB_PATH=%OPENCV_PATH%\opencv\lib
		set OPENCV_BIN_PATH=%OPENCV_PATH%\opencv\bin
		set OPENCV_STATICLIB_PATH=%OPENCV_PATH%\opencv\lib
