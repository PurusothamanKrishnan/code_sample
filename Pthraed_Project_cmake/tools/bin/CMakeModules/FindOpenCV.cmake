...
if(NOT DEFINED OpenCV_DIR)
	#message("Looking for OpenCVConfig.cmake")
...
if(EXISTS "${OpenCV_DIR}")
        ...
        if(EXISTS "${OpenCV_DIR}/OpenCVConfig.cmake")
				#message("Using custom config ${OpenCV_DIR}/OpenCVConfig.cmake")
        ...
        #Otherwise it try to guess it.
				...
				#message("Not using custom config ${OpenCV_DIR}/OpenCVConfig.cmake")
				
                set(OPENCV_LIB_COMPONENTS cxcore cv ml highgui cvaux)
                find_path(OpenCV_INCLUDE_DIR "cv.h" PATHS "${OpenCV_DIR}" PATH_SUFFIXES "inc" "include" "include/opencv" DOC "")
        ...
        foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
				#message("Looking for ${__CVLIB}")
				
				# Currently no support for debug libs
                #find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "${__CVLIB}${CVLIB_SUFFIX}d.lib" "lib${__CVLIB}${CVLIB_SUFFIX}d.lib" PATHS "${OpenCV_DIR}/lib" NO_DEFAULT_PATH)
                find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "${__CVLIB}.lib"  PATHS "${OpenCV_DIR}/lib" NO_DEFAULT_PATH)
                find_library(OpenCV_${__CVLIB}_LIBRARY_RELEASE NAMES "${__CVLIB}.lib" PATHS "${OpenCV_DIR}/lib" NO_DEFAULT_PATH)
